...
#ifndef DeSalvoGraph_h
#define DeSalvoGraph_h
...
namespace desalvo_standard_library {
    ...
    namespace polymorphic {
        // Forward reference to class Graph for the Node and Edge classes.
        class Graph;
        class Node;
        ...
        /** @class Edge
            ...
            This class stores a Graph* object, as well as a vector of Node* 
        ...
        */
        ...
        public:
            ...
            // No default or copy construction allowed, must always refer to a Graph and never be copied.
            Edge() = delete;
            Edge(Edge& e) = delete;
        ...
        */
        ...
        public:
            ...
            UndirectedEdge(Graph* initial_graph, Node* initial_first_node, Node* initial_second_node);
        ...
        public:
            ...
            DirectedEdge(Graph* initial_graph, Node* initial_start, Node* initial_stop);
        ...
        public:
            ...
            WeightedDirectedEdge(Graph* initial_graph, Node* initial_start, Node* initial_stop, double initial_weight);
        ...
        public:
            ...
            Node(Node&&) = default;
            Node(Graph* initial_graph); // : graph(initial_graph) { }
            Node(Graph* initial_graph, Edge* initial_edge); // : graph(initial_graph) { incident_edges.push_back(initial_edge); }
            Node(Graph* initial_graph, std::vector<Edge*>& initial_incident_edges); // : graph(initial_graph), incident_edges(initial_incident_edges) { }
        ...
        public:
            ...
            LabelledNode(Graph* initial_graph, std::string initial_label); // : Node(initial_graph), label(initial_label) { initial_graph->add_node(this); };
            LabelledNode(Graph* initial_graph, Edge* initial_edge, const std::string& initial_label); // : Node(initial_graph, initial_edge), label(initial_label) { initial_graph->add_node(this); };
            LabelledNode(Graph* initial_graph, std::vector<Edge*>& initial_incident_edges, const std::string& initial_label); // : Node(initial_graph, initial_incident_edges), label(initial_label) { initial_graph->add_node(this); };
        ...
        */
        ...
        public:
            ...
            /** Constructs a Graph using the input nodes and edges.
            ...
            */
            Graph(std::vector<Node*>& initial_nodes, std::vector<Edge*>& initial_edges) : nodes(initial_nodes), edges(initial_edges) { }


            /** Move constructor simply moves the nodes and edges along and clear out the vectors in g.
                @param g is the existing Graph object.
            */
            ...
            virtual ~Graph() {
                //std::cout << "Calling the Graph Destructor" << std::endl;
            ...
            */
            virtual const Node* initial_state() const { return nodes[0]; }

            virtual std::vector<const Node*> neighbors(const Node* state, bool directed) const;
            virtual std::pair<std::vector<const Node*>, std::vector<double>> neighbors_and_weights(const Node* state, bool directed) const;
        ...
        */
        ...
        /** Node constructor.  Importantly, it instructs the graph to add the node,
            ...
            @param initial_graph is the Graph object the Node belongs to.
        */
        Node::Node(Graph* initial_graph) : graph(initial_graph) { 
            graph->add_node(this);
        }

        /** Node constructor.  Importantly, it instructs the graph to add the node,
            so that none of the derived classes needs to worry about it.  
            @param initial_graph is a Graph pointer in which the Node belongs to.
            @param initial_edge is an edge which is incident to the node.
        */
        Node::Node(Graph* initial_graph, Edge* initial_edge) : graph(initial_graph) { 
        ...
        */
        Node::Node(Graph* initial_graph, std::vector<Edge*>& initial_incident_edges) : graph(initial_graph), incident_edges(initial_incident_edges) { 
            graph->add_node(this);
        }
        ...
        */
        LabelledNode::LabelledNode(Graph* initial_graph, std::string initial_label) : Node(initial_graph), label(initial_label) { 
        ...
        /** LabelledNode constructor.  Importantly, it uses the base Node class implmentation to connect
            ...
            @param initial_label is the initial label for the node.        
        */
        LabelledNode::LabelledNode(Graph* initial_graph, Edge* initial_edge, const std::string& initial_label) : Node(initial_graph, initial_edge), label(initial_label) { 
            // Node base class and field initializer list takes care of everything
        };
        ...
        /** LabelledNode constructor.  Importantly, it uses the base Node class implmentation to connect
            ...
            @param initial_label is the initial label for the node.
        */
        LabelledNode::LabelledNode(Graph* initial_graph, std::vector<Edge*>& initial_incident_edges, const std::string& initial_label) : Node(initial_graph, initial_incident_edges), label(initial_label) {
            // Node base class and field initializer list takes care of everything
        };

        /** Edge constructor.  Importantly, it instructs the graph to add the edge,
            so that none of the derived classes needs to worry about it.
            @param initial_graph is a Graph pointer in which the Edge belongs to.
        */
        Edge::Edge(Graph* initial_graph) : graph(initial_graph) { 
        ...
        */
        UndirectedEdge::UndirectedEdge(Graph* initial_graph, Node* initial_first_node, Node* initial_second_node) : Edge(initial_graph) { 
        ...
        */
        DirectedEdge::DirectedEdge(Graph* initial_graph, Node* initial_start, Node* initial_stop) : Edge(initial_graph) {
        ...
        */
        WeightedDirectedEdge::WeightedDirectedEdge(Graph* initial_graph, Node* initial_start, Node* initial_stop, double initial_weight) : DirectedEdge(initial_graph, initial_start, initial_stop), weight(initial_weight) { 
        ...
        */
        std::vector<const Node*> Graph::neighbors(const Node* state, bool directed) const {
        ...
        /** Returns a vector of neighbors incident to a given node.
            ...
            @returns a vector of nodes which are neighbors to state.
        */
        std::pair<std::vector<const Node*>, std::vector<double>> Graph::neighbors_and_weights(const Node* state, bool directed) const {
            // Only works for graphs, not yet hyper graphs where a hyperedge can connect 3 or more nodes.
        ...
        */
        Graph complete_graph(unsigned int k) {
        ...
        */
        ...
        Graph random_graph(unsigned int k, double p, URNG& generator) {
            Graph graph; // = new Graph;
        ...
        */
        template<typename URNG=std::default_random_engine>
        Graph random_weighted_complete_directed_graph(unsigned int k, URNG& generator) {
            Graph graph; // = new Graph;
        ...
        */
        template<typename URNG=std::default_random_engine>
        Graph random_weighted_complete_directed_graph_with_source_sink(unsigned int k, URNG& generator) {
            Graph graph; // = new Graph;
        ...
        */
        template<typename URNG=std::default_random_engine>
        Graph random_weighted_line_with_source_sink(unsigned int k, URNG& generator) {
        ...
        */
        Graph graph_from_file(std::string filename) {
